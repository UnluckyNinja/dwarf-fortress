...
template< class T, class T2, class T3, class T4 > void add_quad_unique_to_vectors(T nl, T2 nl2, T3 nl3, T4 nl4, svector< T > &vc, svector< T2 > &vc2, svector< T3 > &vc3, svector< T4 > &vc4) {
  auto ii_s = vc.begin(), ii_e = vc.end();
  auto ii_s2 = vc2.begin(), ii_e2 = vc2.end();
...
template< class T, class T2, class T3, class T4 > int32_t get_quad_vector_index(T a1, T2 a2, T3 a3, T4 a4, svector< T > &vc, svector< T2 > &vc2, svector< T3 > &vc3, svector< T4 > &vc4) {
  auto ii_s = vc.begin(), ii_e = vc.end();
  auto ii_s2 = vc2.begin(), ii_e2 = vc2.end();
  auto ii_s3 = vc3.begin(), ii_e3 = vc3.end();
  auto ii_s4 = vc4.begin(), ii_e4 = vc4.end();
...
template< class T, class T2, class T3, class T4 > void merge_quad_vectors(T &master, T2 &master2, T3 &master3, T4 &master4, T &merger, T2 &merger2, T3 &merger3, T4 &merger4) {
  auto ii_s = merger.begin(), ii_e = merger.end();
  auto ii_s2 = merger2.begin(), ii_e2 = merger2.end();
  ...
  for (; ii_s < ii_e; ++ii_s, ++ii_s2, ++ii_s3, ++ii_s4) {
    ...
    for (; ii_s5 < ii_e5; ++ii_s5, ++ii_s6, ++ii_s7, ++ii_s8) {
      if ((*ii_s) == (*ii_s5) && (*ii_s2) == (*ii_s6) && (*ii_s3) == (*ii_s7) && (*ii_s4) == (*ii_s8))
        break;
    }
    if (ii_s5 >= ii_e5) {
      master.push_back((*ii_s));
