...
bool musicsoundst::initsound() {
  ...
  if (devices == 0) {
    __info
      << "No sound devices available. Sound disabled. OpenAL broken?";
    return false;
  }
  ...
  __info
    << "Picking " << firstdevice << ". " << "If your desired device was missing, make sure you have the appropriate 32-bit libraries installed. "
  ...
  const ALCint attrlist[] = { ALC_FREQUENCY, SOUND_FREQUENCY, ALC_MONO_SOURCES, 0, ALC_STEREO_SOURCES, SOUND_CHANNELNUM };
  ...
  if (context == 0) {
    ...
    if (context == 0) {
      ...
      __info
        << "Using OpenAL in compatibility mode";
    }
  } else {
    __info
...
void musicsoundst::set_song(::std::string& filename, int slot) {
  set_song(filename, ::std::make_pair(true, slot));
}

void musicsoundst::startbackgroundmusic(int slot) {
  startbackgroundmusic(::std::make_pair(true, slot));
}
...
void musicsoundst::stopbackgroundmusic() {
  ...
  if (background_slot == ::std::make_pair(false, -1)) {
    return;
  }
...
static bool init_openal() {
  ...
  //    return false;
  //
  //  if (!linkit((void**) &_alEnable, "alEnable", handle))
  //    return false;
  //  if (!linkit((void**) &_alDisable, "alDisable", handle))
  //    return false;
  //  if (!linkit((void**) &_alIsEnabled, "alIsEnabled", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetString, "alGetString", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetBooleanv, "alGetBooleanv", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetIntegerv, "alGetIntegerv", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetFloatv, "alGetFloatv", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetDoublev, "alGetDoublev", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetBoolean, "alGetBoolean", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetInteger, "alGetInteger", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetFloat, "alGetFloat", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetDouble, "alGetDouble", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetError, "alGetError", handle))
  //    return false;
  //  if (!linkit((void**) &_alIsExtensionPresent, "alIsExtensionPresent", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetProcAddress, "alGetProcAddress", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetEnumValue, "alGetEnumValue", handle))
  //    return false;
  //  if (!linkit((void**) &_alListenerf, "alListenerf", handle))
  //    return false;
  //  if (!linkit((void**) &_alListener3f, "alListener3f", handle))
  //    return false;
  //  if (!linkit((void**) &_alListenerfv, "alListenerfv", handle))
  //    return false;
  //  if (!linkit((void**) &_alListeneri, "alListeneri", handle))
  //    return false;
  //  if (!linkit((void**) &_alListener3i, "alListener3i", handle))
  //    return false;
  //  if (!linkit((void**) &_alListeneriv, "alListeneriv", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetListenerf, "alGetListenerf", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetListener3f, "alGetListener3f", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetListenerfv, "alGetListenerfv", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetListeneri, "alGetListeneri", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetListener3i, "alGetListener3i", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetListeneriv, "alGetListeneriv", handle))
  //    return false;
  //  if (!linkit((void**) &_alGenSources, "alGenSources", handle))
  //    return false;
  //  if (!linkit((void**) &_alDeleteSources, "alDeleteSources", handle))
  //    return false;
  //  if (!linkit((void**) &_alIsSource, "alIsSource", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourcef, "alSourcef", handle))
  //    return false;
  //  if (!linkit((void**) &_alSource3f, "alSource3f", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourcefv, "alSourcefv", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourcei, "alSourcei", handle))
  //    return false;
  //  if (!linkit((void**) &_alSource3i, "alSource3i", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourceiv, "alSourceiv", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetSourcef, "alGetSourcef", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetSource3f, "alGetSource3f", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetSourcefv, "alGetSourcefv", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetSourcei, "alGetSourcei", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetSource3i, "alGetSource3i", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetSourceiv, "alGetSourceiv", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourcePlayv, "alSourcePlayv", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourceStopv, "alSourceStopv", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourceRewindv, "alSourceRewindv", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourcePausev, "alSourcePausev", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourcePlay, "alSourcePlay", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourceStop, "alSourceStop", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourceRewind, "alSourceRewind", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourcePause, "alSourcePause", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourceQueueBuffers, "alSourceQueueBuffers", handle))
  //    return false;
  //  if (!linkit((void**) &_alSourceUnqueueBuffers, "alSourceUnqueueBuffers", handle))
  //    return false;
  //  if (!linkit((void**) &_alGenBuffers, "alGenBuffers", handle))
  //    return false;
  //  if (!linkit((void**) &_alDeleteBuffers, "alDeleteBuffers", handle))
  //    return false;
  //  if (!linkit((void**) &_alIsBuffer, "alIsBuffer", handle))
  //    return false;
  //  if (!linkit((void**) &_alBufferData, "alBufferData", handle))
  //    return false;
  //  if (!linkit((void**) &_alBufferf, "alBufferf", handle))
  //    return false;
  //  if (!linkit((void**) &_alBuffer3f, "alBuffer3f", handle))
  //    return false;
  //  if (!linkit((void**) &_alBufferfv, "alBufferfv", handle))
  //    return false;
  //  if (!linkit((void**) &_alBufferi, "alBufferi", handle))
  //    return false;
  //  if (!linkit((void**) &_alBuffer3i, "alBuffer3i", handle))
  //    return false;
  //  if (!linkit((void**) &_alBufferiv, "alBufferiv", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetBufferf, "alGetBufferf", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetBuffer3f, "alGetBuffer3f", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetBufferfv, "alGetBufferfv", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetBufferi, "alGetBufferi", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetBuffer3i, "alGetBuffer3i", handle))
  //    return false;
  //  if (!linkit((void**) &_alGetBufferiv, "alGetBufferiv", handle))
  //    return false;
  //  if (!linkit((void**) &_alDopplerFactor, "alDopplerFactor", handle))
  //    return false;
  //  if (!linkit((void**) &_alDopplerVelocity, "alDopplerVelocity", handle))
  //    return false;
  //  if (!linkit((void**) &_alSpeedOfSound, "alSpeedOfSound", handle))
  //    return false;
  //  if (!linkit((void**) &_alDistanceModel, "alDistanceModel", handle))
  //    return false;
  //  if (!linkit((void**) &_alcCreateContext, "alcCreateContext", handle))
  //    return false;
  //  if (!linkit((void**) &_alcMakeContextCurrent, "alcMakeContextCurrent", handle))
  //    return false;
  //  if (!linkit((void**) &_alcProcessContext, "alcProcessContext", handle))
  //    return false;
  //  if (!linkit((void**) &_alcSuspendContext, "alcSuspendContext", handle))
  //    return false;
  //  if (!linkit((void**) &_alcDestroyContext, "alcDestroyContext", handle))
  //    return false;
  //  if (!linkit((void**) &_alcGetCurrentContext, "alcGetCurrentContext", handle))
  //    return false;
  //  if (!linkit((void**) &_alcGetContextsDevice, "alcGetContextsDevice", handle))
  //    return false;
  //  if (!linkit((void**) &_alcOpenDevice, "alcOpenDevice", handle))
  //    return false;
  //  if (!linkit((void**) &_alcCloseDevice, "alcCloseDevice", handle))
  //    return false;
  //  if (!linkit((void**) &_alcGetError, "alcGetError", handle))
  //    return false;
  //  if (!linkit((void**) &_alcIsExtensionPresent, "alcIsExtensionPresent", handle))
  //    return false;
  //  if (!linkit((void**) &_alcGetProcAddress, "alcGetProcAddress", handle))
  //    return false;
  //  if (!linkit((void**) &_alcGetEnumValue, "alcGetEnumValue", handle))
  //    return false;
  //  if (!linkit((void**) &_alcGetString, "alcGetString", handle))
  //    return false;
  //  if (!linkit((void**) &_alcGetIntegerv, "alcGetIntegerv", handle))
  //    return false;
  //  if (!linkit((void**) &_alcCaptureOpenDevice, "alcCaptureOpenDevice", handle))
  //    return false;
  //  if (!linkit((void**) &_alcCaptureCloseDevice, "alcCaptureCloseDevice", handle))
  //    return false;
  //  if (!linkit((void**) &_alcCaptureStart, "alcCaptureStart", handle))
  //    return false;
  //  if (!linkit((void**) &_alcCaptureStop, "alcCaptureStop", handle))
  //    return false;
  //  if (!linkit((void**) &_alcCaptureSamples, "alcCaptureSamples", handle))
  //    return false;
  //
  //  return true;
  return false;
...
void alListenerf(ALenum param, ALfloat value) {
  return _alListenerf(param, value);
}
void alListener3f(ALenum param, ALfloat value1, ALfloat value2, ALfloat value3) {
  return _alListener3f(param, value1, value2, value3);
}
void alListenerfv(ALenum param, const ALfloat* values) {
  return _alListenerfv(param, values);
}
void alListeneri(ALenum param, ALint value) {
  return _alListeneri(param, value);
}
void alListener3i(ALenum param, ALint value1, ALint value2, ALint value3) {
  return _alListener3i(param, value1, value2, value3);
}
void alListeneriv(ALenum param, const ALint* values) {
  return _alListeneriv(param, values);
}
void alGetListenerf(ALenum param, ALfloat* value) {
  return _alGetListenerf(param, value);
}
void alGetListener3f(ALenum param, ALfloat *value1, ALfloat *value2, ALfloat *value3) {
  return _alGetListener3f(param, value1, value2, value3);
}
void alGetListenerfv(ALenum param, ALfloat* values) {
  return _alGetListenerfv(param, values);
}
void alGetListeneri(ALenum param, ALint* value) {
  return _alGetListeneri(param, value);
}
void alGetListener3i(ALenum param, ALint *value1, ALint *value2, ALint *value3) {
  return _alGetListener3i(param, value1, value2, value3);
}
void alGetListeneriv(ALenum param, ALint* values) {
  return _alGetListeneriv(param, values);
}
void alGenSources(ALsizei n, ALuint* sources) {
  return _alGenSources(n, sources);
}
void alDeleteSources(ALsizei n, const ALuint* sources) {
  return _alDeleteSources(n, sources);
}
ALboolean alIsSource(ALuint sid) {
  return _alIsSource(sid);
}
void alSourcef(ALuint sid, ALenum param, ALfloat value) {
  return _alSourcef(sid, param, value);
}
void alSource3f(ALuint sid, ALenum param, ALfloat value1, ALfloat value2, ALfloat value3) {
  return _alSource3f(sid, param, value1, value2, value3);
}
void alSourcefv(ALuint sid, ALenum param, const ALfloat* values) {
  return _alSourcefv(sid, param, values);
}
void alSourcei(ALuint sid, ALenum param, ALint value) {
  return _alSourcei(sid, param, value);
}
void alSource3i(ALuint sid, ALenum param, ALint value1, ALint value2, ALint value3) {
  return _alSource3i(sid, param, value1, value2, value3);
}
void alSourceiv(ALuint sid, ALenum param, const ALint* values) {
  return _alSourceiv(sid, param, values);
}
void alGetSourcef(ALuint sid, ALenum param, ALfloat* value) {
  return _alGetSourcef(sid, param, value);
}
void alGetSource3f(ALuint sid, ALenum param, ALfloat* value1, ALfloat* value2, ALfloat* value3) {
  return _alGetSource3f(sid, param, value1, value2, value3);
}
void alGetSourcefv(ALuint sid, ALenum param, ALfloat* values) {
  return _alGetSourcefv(sid, param, values);
}
void alGetSourcei(ALuint sid, ALenum param, ALint* value) {
  return _alGetSourcei(sid, param, value);
}
void alGetSource3i(ALuint sid, ALenum param, ALint* value1, ALint* value2, ALint* value3) {
  return _alGetSource3i(sid, param, value1, value2, value3);
}
void alGetSourceiv(ALuint sid, ALenum param, ALint* values) {
  return _alGetSourceiv(sid, param, values);
}
void alSourcePlayv(ALsizei ns, const ALuint *sids) {
  return _alSourcePlayv(ns, sids);
}
void alSourceStopv(ALsizei ns, const ALuint *sids) {
  return _alSourceStopv(ns, sids);
}
void alSourceRewindv(ALsizei ns, const ALuint *sids) {
  return _alSourceRewindv(ns, sids);
}
void alSourcePausev(ALsizei ns, const ALuint *sids) {
  return _alSourcePausev(ns, sids);
}
...
void alSourceQueueBuffers(ALuint sid, ALsizei numEntries, const ALuint *bids) {
  return _alSourceQueueBuffers(sid, numEntries, bids);
}
void alSourceUnqueueBuffers(ALuint sid, ALsizei numEntries, ALuint *bids) {
  return _alSourceUnqueueBuffers(sid, numEntries, bids);
}
void alGenBuffers(ALsizei n, ALuint* buffers) {
  return _alGenBuffers(n, buffers);
}
void alDeleteBuffers(ALsizei n, const ALuint* buffers) {
  return _alDeleteBuffers(n, buffers);
}
...
void alcGetIntegerv(ALCdevice *device, ALCenum param, ALCsizei size, ALCint *data) {
  return _alcGetIntegerv(device, param, size, data);
}
...
static bool init_sndfile() {
  ...
  //    return false;
  //
  //  if (!linkit((void**) &_sf_open, "sf_open", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_open_fd, "sf_open_fd", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_open_virtual, "sf_open_virtual", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_error, "sf_error", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_strerror, "sf_strerror", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_error_number, "sf_error_number", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_perror, "sf_perror", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_error_str, "sf_error_str", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_command, "sf_command", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_format_check, "sf_format_check", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_seek, "sf_seek", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_set_string, "sf_set_string", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_get_string, "sf_get_string", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_version_string, "sf_version_string", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_read_raw, "sf_read_raw", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_write_raw, "sf_write_raw", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_readf_short, "sf_readf_short", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_writef_short, "sf_writef_short", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_readf_int, "sf_readf_int", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_writef_int, "sf_writef_int", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_readf_float, "sf_readf_float", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_writef_float, "sf_writef_float", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_readf_double, "sf_readf_double", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_writef_double, "sf_writef_double", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_read_short, "sf_read_short", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_write_short, "sf_write_short", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_read_int, "sf_read_int", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_write_int, "sf_write_int", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_read_float, "sf_read_float", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_write_float, "sf_write_float", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_read_double, "sf_read_double", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_write_double, "sf_write_double", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_close, "sf_close", handle))
  //    return false;
  //  if (!linkit((void**) &_sf_write_sync, "sf_write_sync", handle))
  //    return false;
  //
  //  return true;
  return false;
...
SNDFILE* sf_open(const char *path, int mode, SF_INFO *sfinfo) {
  return _sf_open(path, mode, sfinfo);
}
SNDFILE* sf_open_fd(int fd, int mode, SF_INFO *sfinfo, int close_desc) {
  return _sf_open_fd(fd, mode, sfinfo, close_desc);
}
SNDFILE* sf_open_virtual(SF_VIRTUAL_IO *sfvirtual, int mode, SF_INFO *sfinfo, void *user_data) {
  return _sf_open_virtual(sfvirtual, mode, sfinfo, user_data);
}
...
int sf_error_str(SNDFILE *sndfile, char* str, size_t len) {
  return _sf_error_str(sndfile, str, len);
}
int sf_command(SNDFILE *sndfile, int command, void *data, int datasize) {
  return _sf_command(sndfile, command, data, datasize);
}
int sf_format_check(const SF_INFO *info) {
  return _sf_format_check(info);
}
sf_count_t sf_seek(SNDFILE *sndfile, sf_count_t frames, int whence) {
  return _sf_seek(sndfile, frames, whence);
}
int sf_set_string(SNDFILE *sndfile, int str_type, const char* str) {
  return _sf_set_string(sndfile, str_type, str);
}
const char* sf_get_string(SNDFILE *sndfile, int str_type) {
  return _sf_get_string(sndfile, str_type);
}
const char * sf_version_string(void) {
  return _sf_version_string();
}
sf_count_t sf_read_raw(SNDFILE *sndfile, void *ptr, sf_count_t bytes) {
  return _sf_read_raw(sndfile, ptr, bytes);
}
sf_count_t sf_write_raw(SNDFILE *sndfile, const void *ptr, sf_count_t bytes) {
  return _sf_write_raw(sndfile, ptr, bytes);
}
sf_count_t sf_readf_short(SNDFILE *sndfile, short *ptr, sf_count_t frames) {
  return _sf_readf_short(sndfile, ptr, frames);
}
sf_count_t sf_writef_short(SNDFILE *sndfile, const short *ptr, sf_count_t frames) {
  return _sf_writef_short(sndfile, ptr, frames);
}
sf_count_t sf_readf_int(SNDFILE *sndfile, int *ptr, sf_count_t frames) {
  return _sf_readf_int(sndfile, ptr, frames);
}
sf_count_t sf_writef_int(SNDFILE *sndfile, const int *ptr, sf_count_t frames) {
  return _sf_writef_int(sndfile, ptr, frames);
}
sf_count_t sf_readf_float(SNDFILE *sndfile, float *ptr, sf_count_t frames) {
  return _sf_readf_float(sndfile, ptr, frames);
}
sf_count_t sf_writef_float(SNDFILE *sndfile, const float *ptr, sf_count_t frames) {
  return _sf_writef_float(sndfile, ptr, frames);
}
sf_count_t sf_readf_double(SNDFILE *sndfile, double *ptr, sf_count_t frames) {
  return _sf_readf_double(sndfile, ptr, frames);
}
sf_count_t sf_writef_double(SNDFILE *sndfile, const double *ptr, sf_count_t frames) {
  return _sf_writef_double(sndfile, ptr, frames);
}
sf_count_t sf_read_short(SNDFILE *sndfile, short *ptr, sf_count_t items) {
  return _sf_read_short(sndfile, ptr, items);
}
sf_count_t sf_write_short(SNDFILE *sndfile, const short *ptr, sf_count_t items) {
  return _sf_write_short(sndfile, ptr, items);
}
sf_count_t sf_read_int(SNDFILE *sndfile, int *ptr, sf_count_t items) {
  return _sf_read_int(sndfile, ptr, items);
}
sf_count_t sf_write_int(SNDFILE *sndfile, const int *ptr, sf_count_t items) {
  return _sf_write_int(sndfile, ptr, items);
}
sf_count_t sf_read_float(SNDFILE *sndfile, float *ptr, sf_count_t items) {
  return _sf_read_float(sndfile, ptr, items);
}
sf_count_t sf_write_float(SNDFILE *sndfile, const float *ptr, sf_count_t items) {
  return _sf_write_float(sndfile, ptr, items);
}
sf_count_t sf_read_double(SNDFILE *sndfile, double *ptr, sf_count_t items) {
  return _sf_read_double(sndfile, ptr, items);
}
sf_count_t sf_write_double(SNDFILE *sndfile, const double *ptr, sf_count_t items) {
  return _sf_write_double(sndfile, ptr, items);
}
